...
(85, 1, 'First Article Title', 'First Article Body'),
(86, 1, 'Second Article Title', 'Second Article body');
...
INSERT INTO `comments` (`id`, `user_id`, `article_id`, `title`, `body`) VALUES
(66, 2, 85, 'Comment Title', 'Verry Strong Article!');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `city`, `phone`, `website`, `company`, `password`) VALUES
(1, 'Aļgis', 'Bernatovičs', 'algis.bernatovics@gmail.com', 'Dobele', '00000000', 'localhost', 'Home', '$2y$10$kh.BGPEtcXsnHWygMXRUk.RhJjuvv37U6HNVZ7s4bNBVbRkScWlA2'),
(2, 'Mulder', 'Fox', 'mulder.fox@gmail.com', 'Alexandria', '00000000', 'x-files.com', 'FBI', '$2y$10$kh.BGPEtcXsnHWygMXRUk.RhJjuvv37U6HNVZ7s4bNBVbRkScWlA2');
